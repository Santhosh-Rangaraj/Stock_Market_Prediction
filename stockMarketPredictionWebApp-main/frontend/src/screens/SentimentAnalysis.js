...
import { getTwitterAnalysis } from '../actions/analysisActions';
import chart from '../assets/invest.png'
...
const SentimentAnalysis = () => {
	...
	const twitterAnalysis = useSelector((state) => state.twitterAnalysis)
	const {loading, error, info} = twitterAnalysis
	...
	const submitInfo = () => {
		...
		dispatch(getTwitterAnalysis(name))
	}
	...
	return (
		<>
			...
			<div className="flex items-center justify-center flex-col">
				...
				<p className="text-lg">Twitter Data Analysis</p>
				</div>
